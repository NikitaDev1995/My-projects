...
class ScheduleTableViewCell: UITableViewCell {
    ...
    private let lessonName = UILabel(text: "", font: .avenirNextDemiBold20(), color: .black)
    private let teacherName = UILabel(text: "Хотеева Лариса Александровна", font: .avenirNext20(), color: .black, aligment: .right)
    private let lessonTime = UILabel(text: "", font: .avenirNextDemiBold20(), color: .black)
    private let typeLabel = UILabel(text: "Type", font: .avenirNext14(), color: .black, aligment: .right)
    private let lessonType = UILabel(text: "", font: .avenirNextDemiBold14(), color: .black)
    private let buildingLabel = UILabel(text: "Building", font: .avenirNext14(), color: .black)
    private let lessonBuilding = UILabel(text: "", font: .avenirNextDemiBold14(), color: .black)
    private let audLabel = UILabel(text: "Audience", font: .avenirNext14(), color: .black, aligment: .right)
    private let lessonAud = UILabel(text: "", font: .avenirNextDemiBold14(), color: .black)
    ...
    func configure(model: ScheduleModel) {
        ...
        guard let time = model.scheduleTime else {
            return
        }
